...
function sfs_render_form() {
	...
	<div class="wrap sfs-admin">
		...
		<div class="metabox-holder">
			<div class="meta-box-sortables ui-sortable">
					...
					<div class="toggle">
						<div class="mm-panel-alert">
							<p>
								...
								<a target="_blank" href="https://m0n.co/donate" title="<?php esc_attr_e('Make a donation via PayPal', 'simple-feed-stats'); ?>"><?php esc_html_e('make a donation', 'simple-feed-stats'); ?></a> 
				...
				<div class="postbox">
					...
					<div class="toggle sfs-overview<?php if (isset($_GET['settings-updated']) || isset($_GET['filter']) || isset($_GET['p'])) echo ' default-hidden'; ?>">
						<p>
				...
				<div class="postbox">
					...
					<div class="toggle default-hidden">
						...
						<div class="sfs-table">
							<ul>
								<li><?php esc_html_e('Content RDF',   'simple-feed-stats'); ?> &ndash; <a target="_blank" href="<?php echo esc_attr($feed_rdf);       ?>"><code><?php echo esc_url($feed_rdf);       ?></code></a></li>
								<li><?php esc_html_e('Content RSS2',  'simple-feed-stats'); ?> &ndash; <a target="_blank" href="<?php echo esc_attr($feed_rss2);      ?>"><code><?php echo esc_url($feed_rss2);      ?></code></a></li>
								<li><?php esc_html_e('Content Atom',  'simple-feed-stats'); ?> &ndash; <a target="_blank" href="<?php echo esc_attr($feed_atom);      ?>"><code><?php echo esc_url($feed_atom);      ?></code></a></li>
								<li><?php esc_html_e('Comments RSS2', 'simple-feed-stats'); ?> &ndash; <a target="_blank" href="<?php echo esc_attr($feed_coms);      ?>"><code><?php echo esc_url($feed_coms);      ?></code></a></li>
								<li><?php esc_html_e('Comments Atom', 'simple-feed-stats'); ?> &ndash; <a target="_blank" href="<?php echo esc_attr($feed_coms_atom); ?>"><code><?php echo esc_url($feed_coms_atom); ?></code></a></li>
							</ul>
						</div>
				...
				<div id="sfs-shortcodes" class="postbox">
					...
					<div class="toggle default-hidden">
						...
						<p><code>[sfs_count_simple link="http://example.com/feed/"]</code></p>
						...
						<p><code>&lt;?php if (function_exists('sfs_display_count_simple')) sfs_display_count_simple(array('link' => 'http://example.com/feed/')); ?&gt;</code></p>
				...
				<div class="postbox">
					...
					<div class="toggle toggle-support">
		...
		<div class="sfs-credits">
			...
			<a target="_blank" href="https://monzillamedia.com/" title="<?php esc_attr_e('Obsessive Web Design &amp; Development', 'simple-feed-stats'); ?>">Monzilla Media</a>
		</div>
	</div>
