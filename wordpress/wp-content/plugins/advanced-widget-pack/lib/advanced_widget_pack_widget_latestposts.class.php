<?php
/**
 * Advanced Widget Pack - Latest Posts
 */

class Advanced_Widget_Pack_Widget_LatestPosts extends WP_Widget {
	
	/* The plugins slug */
	const SLUG = 'awp_latest_posts';
	...
	public function __construct(){
		...
		$widgetOptions = array(
			'classname' => self::SLUG,
			'description' => __('Displays a custom list of latest posts including thumbnail images.', self::SLUG)
		);
		...
		/* Create the widget */
		$this->WP_Widget(self::SLUG, __('AWP - Latest Posts', self::SLUG), $widgetOptions, $controlOptions);
	...
	public function form($instance) {
		...
		?>
            ...
            <fieldset class="widefat advancedwidgetpack-general">
                ...
                <legend><?php _e('Latest Posts Settings', self::SLUG); ?></legend>
	...
	public function widget($args, $instance){
		...
		if(!empty($count)){
			...
			if($title) echo $before_title.$title.$after_title;	
				...
				?>
				<!-- Advanced Widget Pack: Latest Posts Widget - http://www.wpinsite.com -->
				<div class="textwidget">
					<div class="advancedwidgetpack" <?php echo $widgetwidth == '' ? '' : 'style="width:'.$widgetwidth.$width_by.' !important"';?>>
						<?php 
							$this->advanced_widget_pack->awp_get_posts('latest', $cat, $post_type, $count, $chars, $thumbnail == true ? true : false);
						?>
						<div class="clear"></div>
					</div>
				</div>
				<!-- End Advanced Widget Pack: Latest Posts Widget -->
				<?php
